...
class UniversalProfilePage extends StatefulWidget {
  const UniversalProfilePage({super.key});

  @override
  State<UniversalProfilePage> createState() => _UniversalProfilePageState();
}

class _UniversalProfilePageState extends State<UniversalProfilePage> {
